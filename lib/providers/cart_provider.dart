...
import 'package:alisveris_app/models/cart_model.dart';
...
// Firebase
  Future<void> addToCartFirebase({
    ...
    if (user == null) {
      MyAppFunctions.showWarningDialog(
        context: context,
        subtitle: "Giriş yapmak ister misiniz?",
        fct: () {},
      );
      return;
    }
  ...
  Future<void> removeCartItemFromFirestore({
    ...
    try {
      ...
      Fluttertoast.showToast(msg: "Ürün kaldırıldı");
    } catch (e) {
      rethrow;
    }
  }
  ...
  Future<void> clearCartFromFirebase() async {
    ...
    try {
      ...
      // await fetchCart();
      _cartItems.clear();
      Fluttertoast.showToast(msg: "Sepet temizlendi");
    } catch (e) {
      rethrow;
    }
  }
