                    ...
                    child: Column(
                      children: [
                              ...
                              Expanded(
                                child: SizedBox(
                                  ...
                                  child: ElevatedButton.icon(
                                    ...
                                    onPressed: () async {
                                      ...
                                      try {
                                        await cartProvider.addToCartFirebase(
                                            productId: getCurrProduct.productId, qty: 1, context: context);
                                      } catch (e) {
                                    ...
                                    label: Text(cartProvider.isProdinCart(productId: getCurrProduct.productId)
                                        ? "Sepette"
                                        : "Sepete ekle"),
                                  ),
                                ),
                        ...
                        Row(
                          ...
                          children: [
                            const TitlesTextWidget(label: "Ürün hakkında"),
                            SubtitleTextWidget(label: "Kategori: ${getCurrProduct.productCategory}"),
                          ],
                        ),
                        const SizedBox(
                          height: 15,
