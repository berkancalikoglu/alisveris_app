...
import 'package:alisveris_app/providers/cart_provider.dart';
import 'package:alisveris_app/screens/cart/cart_widget.dart';
import 'package:alisveris_app/screens/loading_manager.dart';
import 'package:alisveris_app/services/assets_manager.dart';
import 'package:alisveris_app/services/my_app_functions.dart';
    ...
    return cartProvider.getCartitems.isEmpty
        ? Scaffold(
            body: EmptyBagWidget(
              ...
              title: "Sepetin boş",
              subtitle: "Burası boş görünüyor, bir şeyler eklemeye ne dersin?",
        ...
        : Scaffold(
            ...
            appBar: AppBar(
              ...
              title: TitlesTextWidget(label: "Sepet (${cartProvider.getCartitems.length})"),
              actions: [
                IconButton(
                  onPressed: () {
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return ChangeNotifierProvider.value(
                              value: cartProvider.getCartitems.values.toList()[index], child: const CartWidget());
                        }),
                  ),
                  const SizedBox(
