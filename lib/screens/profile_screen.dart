...
import 'package:alisveris_app/screens/auth/login.dart';
import 'package:alisveris_app/screens/inner_screen/viewed_recently.dart';
import 'package:alisveris_app/screens/inner_screen/wishlist.dart';
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomListTile(
                      ...
                      function: () {Fluttertoast.showToast(msg: "Kişisel verilerinizi almayalım :)");},
                    ),
                    ...
                    SwitchListTile(
                      ...
                      title: Text(themeProvider.getIsDarkTheme ? "Karanlık mod" : "Aydınlık mod"),
              ...
              Center(
                child: ElevatedButton.icon(
                  ...
                  label: Text(user == null ? "Giriş" : "Çıkış"),
                  onPressed: () async {
                    if (user == null) {
